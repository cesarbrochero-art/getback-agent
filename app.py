...
<div class="gb-header">
  <div class="gb-logo-row">
    ...
    <div style="margin-left:16px;border-left:1px solid #E2E5EA;padding-left:16px">
      <svg width="230" viewBox="0 0 340 75" xmlns="http://www.w3.org/2000/svg">
        ...
        <text x="170" y="65" font-family="-apple-system, sans-serif" font-size="12" font-weight="400" fill="#185FA5" letter-spacing="1.5" text-anchor="middle" opacity="0.6">PREDICTIVE CLINICAL ALGORITHM</text>
      </svg>
    </div>
  </div>
